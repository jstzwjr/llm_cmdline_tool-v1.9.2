...
call ndk-build -j 8 NDK_PROJECT_PATH=. APP_BUILD_SCRIPT=%LIB_LLM_SRC_PATH%\Android.mk NDK_APPLICATION_MK=%LIB_LLM_SRC_PATH%\Application.mk EXTRA_GLOBAL_CPPFLAGS=%EXTRA_FLAGS% || goto :error
