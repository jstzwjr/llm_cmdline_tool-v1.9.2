...
LLM_RUNTIME_ROOT := $(ROOT_PATH)/llm_runtime
include $(LLM_RUNTIME_ROOT)/Android.mk

IMAGE_UTILS_ROOT := $(ROOT_PATH)/image_utils
include $(IMAGE_UTILS_ROOT)/Android.mk

MLLM_RUNTIME_ROOT := $(ROOT_PATH)/llm_runtime
include $(MLLM_RUNTIME_ROOT)/Android_mllm.mk
...
LOCAL_STATIC_LIBRARIES += backend executor llm_helper llm_runtime
...
LOCAL_SRC_FILES := mtk_mllm.cpp
LOCAL_STATIC_LIBRARIES += backend executor llm_helper mllm_runtime
LOCAL_SHARED_LIBRARIES += common
