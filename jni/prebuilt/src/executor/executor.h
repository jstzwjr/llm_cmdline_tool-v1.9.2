...
#include "executor/utils/mutable_io.h"
...
using executor_utils::MutableIO;

class Executor : public MutableIO, protected MultiRuntimeHandler {
public:
    ...
    // Set generic (uncategorized) number of IOs
